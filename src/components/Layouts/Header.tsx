            ...
            <div className="shadow-sm">
                <div className="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-black">
                    <div className="sm:flex-1 ltr:sm:ml-0 ltr:ml-auto sm:rtl:mr-0 rtl:mr-auto flex items-center justify-end space-x-1.5 lg:space-x-2 rtl:space-x-reverse dark:text-[#d0d2d6]">
                        ...
                        <div className="">
                            <button
                                ...
                                className={`flex items-center p-2 rounded-full ${
                                    isFullscreen ? 'bg-red-500 hover:bg-red-600 text-white' : 'bg-white-light/40 dark:bg-dark/40 hover:text-primary hover:bg-white-light/90 dark:hover:bg-dark/60'
                                }`}
                            >
                                <IconLayoutGrid />
                            </button>
                        ...
                        <div className="">
                            <img src={favicon} alt="MAYORA" style={{ width: '50px', height: '50px' }} />
                        </div>
                    </div>
                </div>
            </div>
